        ...
        <Grid2 container>
            ...
            <Grid2 xs={12} md={3} sx={{ display: { xs: "none", md: "block" } }}>
                <Box sx={{ display: "flex", justifyContent: "space-around", flexDirection: "column", height: "100%", textAlign: { xs: "center", md: "left" } }}>
                    ...
                    <Box>
                    {/* Price: <Box fontWeight={600} display={"inline"}>${product.price}</Box> */}
                        <Typography>Effectiveness Grade: <Box fontWeight={600} display={"inline"}>{product.effectivenessGrade}</Box> {product.fivePrice && <Box display={"inline"}>/ 5 bottles:  <Box fontWeight={600} display={"inline"}>${product.fivePrice}<Box display={"inline"} fontWeight={400}> each</Box></Box></Box>} </Typography>
