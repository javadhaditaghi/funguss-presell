        ...
        <Grid2 container>
            ...
            <Grid2 xs={12} md={3} sx={{ display: { xs: "none", md: "block" } }}>
                <Box sx={{ display: "flex", justifyContent: "space-around", flexDirection: "column", height: "100%", textAlign: { xs: "center", md: "left" } }}>
                    ...
                    <Box>
                        <Link href={product.officialWebsite}> <Button variant="contained" sx={{ background: "linear-gradient(180deg, rgba(255, 255, 255, 0.50) 0%, rgba(255, 255, 255, 0.20) 49%, rgba(0, 0, 0, 0.15) 51%, rgba(0, 0, 0, 0.05) 100%), #28A745" }} >Checkout the Official Website »</Button></Link>
                    </Box>
                </Box>
