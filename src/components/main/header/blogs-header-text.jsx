...
const BlogsHeaderText = () => {
    return (
        <Box sx={{ mt: "650px" }}>
            ...
            <Typography fontFamily={"Poppins"} color={"#ffffff"} fontSize={"18px"}>Aliquam ex nibh, rhoncus quis mi nec, imperdiet mattis est. Suspendisse potenti. Duis vestibulum magna quis suscipit tempus.</Typography>
        </Box>
    )
}
